...
import { AppSettings, UPSData, LogEntry } from '../../types';
...
const SystemSettings: React.FC<Props> = ({ settings, onUpdateSettings, upsData, onResetEnergy, onRequestSecureAction, onLogEvent, onHelp }) => {
